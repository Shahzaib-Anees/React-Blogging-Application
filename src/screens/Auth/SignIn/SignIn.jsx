...
function SignIn() {
  ...
  return (
    <>
      <article className = "w-[100%] h-[87.5vh]">
        <article className="w-[100%] min-h-[45vh] max-h-[fit-content] flex flex-col items-center py-8 px-3 bg-[#f2f2f2] relative">
          <div className="w-[100%] h-[100%] flex flex-col gap-2 justify-center items-center lg:w-[40%] sm:w-[100%]">
            <h1 className="main-heading text-4xl text-[#4f3085] font-bold">Log In</h1>
            <p className="main-paragraph text-[15px] text-[#272727] font-semibold text-center">
              Welcome back blogger ! Let reume your connect with the world of
              Bloggers and let share some exciting and informative chunks with
              the community
            </p>
          </div>
          <div
